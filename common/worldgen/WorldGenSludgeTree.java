...
public class WorldGenSludgeTree extends WorldGenerator
{
    ...
    public WorldGenSludgeTree(boolean par1)
    {
        this(par1, 7, 0, 0, false);
    }

    public WorldGenSludgeTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
                        ...
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var12 != 0 &&
                               !block.isLeaves(par1World, var10, var8, var11) &&
                                var12 != BlocksHelper.SludgeGrass.blockID &&
                                var12 != BlocksHelper.SludgeDirt.blockID &&
            ...
            else
            {
                ...
                if ((var8 == BlocksHelper.SludgeGrass.blockID || var8 == BlocksHelper.SludgeDirt.blockID) && par4 < 256 - var6 - 1)
                {
                    this.setBlock(par1World, par3, par4 - 1, par5, BlocksHelper.SludgeDirt.blockID);
                    var9 = 3;
                    byte var18 = 0;
                    int var13;
                    int var14;
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var14, var11, var16, BlocksHelper.SludgeLeaf.blockID, this.metaLeaves);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, BlocksHelper.SludgeLog.blockID, this.metaWood);
