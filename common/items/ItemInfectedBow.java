...
public class ItemInfectedBow extends ItemBow {

	private Icon icostage1inf;
	private Icon icostage2inf;
	private Icon icostage3inf;

	public ItemInfectedBow(int par1) {
		super(par1);
		this.maxStackSize = 1;
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World,
		...
		if (var5
				|| par3EntityPlayer.inventory
						.hasItem(ItemsHelper.InfectedArrow.itemID)) {
			...
			EntityInfectedArrow var8 = new EntityInfectedArrow(par2World,
			...
			if (var5) {
				...
				par3EntityPlayer.inventory
						.consumeInventoryItem(ItemsHelper.InfectedArrow.itemID);
			}
