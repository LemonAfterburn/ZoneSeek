...
public class RenderInfectedArrow extends Render
{
    public void renderArrow(EntityInfectedArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        this.loadTexture("/mods/zoneseek/textures/items/arrows.png");
        GL11.glPushMatrix();
    ...
    {
        this.renderArrow((EntityInfectedArrow)par1Entity, par2, par4, par6, par8, par9);
    }
}